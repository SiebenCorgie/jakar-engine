    ...
    pub fn start(&mut self) -> thread::JoinHandle<()>{
        ...
        let input_thread = thread::spawn(move ||{
            ...
            loop{
                ...
                //Move into a closure for the polling process to prevent a permanent lock of the events loop
                {
                ...
                //exited the polling, now wait the rest time after overwriting the key map
